...
| ----------------------------------|:-----------------------------:|:---------------------------------:|
| Amazon Linux (2016.09)            | [⇓](https://github.com/curityio/nginx_phantom_token_module/releases/download/1.0.2/amzn.2016.09.ngx_curity_http_phantom_token_module_1.13.7.so) | [⇓](https://github.com/curityio/nginx_phantom_token_module/releases/download/1.0.2/amzn.2016.09.ngx_curity_http_phantom_token_module_1.13.10.so) | 
| Amazon Linux 2 (2017.12)          | [⇓](https://github.com/curityio/nginx_phantom_token_module/releases/download/1.0.2/amzn.2017.12.ngx_curity_http_phantom_token_module_1.13.7.so) | [⇓](https://github.com/curityio/nginx_phantom_token_module/releases/download/1.0.2/amzn.2017.12.ngx_curity_http_phantom_token_module_1.13.10.so)|
